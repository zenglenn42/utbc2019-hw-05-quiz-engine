...
Oh, the other thing I did today was start playing with UML to document my class diagrams. I'm using StarUML which is pretty straight forward. I doc'd up mw [3rd homework](https://github.com/zenglenn42/utbc2019-hw-03-wordgame/blob/master/docs/img/ws-uml.png) assignment and will try to add UML for homeworks [4](https://github.com/zenglenn42/utbc2019-hw-04-crystal-collector/blob/master/docs/img/cc-uml.png) and 5 shortly.
